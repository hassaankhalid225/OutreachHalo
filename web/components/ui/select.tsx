...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-input bg-secondary/40',
      'px-3.5 py-2 text-sm ring-offset-background transition-colors placeholder:text-muted-foreground',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'text-popover-foreground shadow-halo data-[state=open]:animate-in data-[state=closed]:animate-out',
